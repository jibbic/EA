// Livsmedelsverket Enterprise Architecture - Omfattande Exempeldata
// Baserad på offentlig information om Livsmedelsverkets uppdrag och organisation
// ArchiMate 3.1 compliant data model
// Version 2.0 - Fullständig verksamhetsmodell med ~70 applikationer

const sampleData = {
  entities: [
    // ========================================================================
    // STRATEGY LAYER - Goals, Drivers & Principles
    // ========================================================================
    {
      id: 'goal-001',
      entityType: 'Goal',
    ...
    },
    {
      ...
      description: 'Genomföra riskbaserad och effektiv kontroll av livsmedelsaktörer'
    },
    {
      id: 'goal-004',
      entityType: 'Goal',
    ...
    },
    {
      id: 'goal-005',
      entityType: 'Goal',
      name: 'Djurskydd och djurhälsa',
      description: 'Säkerställa gott djurskydd och förebygga djursjukdomar'
    },
    {
      id: 'goal-006',
      entityType: 'Goal',
      name: 'Vetenskapligt baserad verksamhet',
      description: 'Bygga verksamheten på vetenskap och forskning'
    },
    {
      id: 'driver-001',
      entityType: 'Driver',
    ...
    },
    {
      ...
      description: 'Krav på minskad miljöpåverkan från livsmedelsproduktion'
    },
    {
      id: 'driver-005',
      entityType: 'Driver',
      name: 'NIS2-direktivet',
      description: 'Krav på cybersäkerhet för samhällsviktig verksamhet'
    },
    {
      id: 'principle-001',
    ...
    },
    {
      ...
      description: 'Beslut ska baseras på bästa tillgängliga vetenskapliga underlag'
    },
    {
      id: 'principle-004',
      entityType: 'Principle',
      name: 'Digital först',
      description: 'Tjänster och processer ska vara digitala som standard'
    },
    {
      id: 'principle-005',
      entityType: 'Principle',
      name: 'Säkerhet och integritet',
      description: 'Data och system ska skyddas enligt NIS2 och GDPR'
    },
    ...
    // LEVEL 0: Domäner (Högsta nivån)
    {
      id: 'cap-l0-001',
      entityType: 'Capability',
      name: 'Livsmedelssäkerhet',
      description: 'Säkerställa säker mat från jord till bord',
      level: 0
    },
    {
      id: 'cap-l0-002',
      entityType: 'Capability',
      name: 'Dricksvattensäkerhet',
      description: 'Säkerställa säkert dricksvatten',
      level: 0
    },
    {
      id: 'cap-l0-003',
      entityType: 'Capability',
      name: 'Djurskydd och Djurhälsa',
      description: 'Övervaka och säkerställa djurskydd',
      level: 0
    },
    {
      id: 'cap-l0-004',
      entityType: 'Capability',
      name: 'Näring och Hälsa',
      description: 'Främja hälsosamma matvanor',
      level: 0
    },
    {
      id: 'cap-l0-005',
      entityType: 'Capability',
      name: 'Krisberedskap',
      description: 'Hantera livsmedelskriser och utbrott',
      level: 0
    },
    {
      id: 'cap-l0-006',
      entityType: 'Capability',
      name: 'Vetenskap och Innovation',
      description: 'Bedriva forskning och utveckling',
      level: 0
    },
    {
      id: 'cap-l0-007',
      ...
      description: 'Stödja kärnverksamheten med IT, Ekonomi, HR',
      level: 0
    },

    // LEVEL 1: Funktionella områden
    {
      id: 'cap-l1-001',
      entityType: 'Capability',
      name: 'Riskvärdering',
      description: 'Identifiera och värdera risker i livsmedelskedjan',
      level: 1,
      parentId: 'cap-l0-001'
    },
    {
      ...
      description: 'Utföra kontroll av livsmedelsföretag',
      level: 1,
      parentId: 'cap-l0-001'
    },
    {
      id: 'cap-l1-003',
      entityType: 'Capability',
      name: 'Tillståndsgivning',
      description: 'Hantera tillstånd och registreringar',
      level: 1,
      parentId: 'cap-l0-001'
    },
    {
      ...
      description: 'Ta och analysera livsmedelsprover',
      level: 1,
      parentId: 'cap-l0-001'
    },
    {
      id: 'cap-l1-005',
      entityType: 'Capability',
      name: 'Import/Export-kontroll',
      description: 'Kontroll av import och export av livsmedel',
      level: 1,
      parentId: 'cap-l0-001'
    },
    {
      id: 'cap-l1-006',
      entityType: 'Capability',
      name: 'Utbrottshantering',
      description: 'Hantera utbrott av matförgiftning',
      level: 1,
      parentId: 'cap-l0-005'
    },
    {
      id: 'cap-l1-007',
      entityType: 'Capability',
      name: 'Zoonosövervakning',
      description: 'Övervaka zoonoser (djursjukdomar överförbara till människa)',
      level: 1,
      parentId: 'cap-l0-003'
    },
    {
      id: 'cap-l1-008',
      entityType: 'Capability',
      name: 'Dricksvattenkontroll',
      description: 'Kontrollera dricksvattenproduktion',
      level: 1,
      parentId: 'cap-l0-002'
    },
    {
      ...
      description: 'Informera konsumenter om matsäkerhet',
      level: 1,
      parentId: 'cap-l0-004'
    },
    {
      id: 'cap-l1-010',
      entityType: 'Capability',
      name: 'Regelutveckling',
      description: 'Utveckla regelverk och föreskrifter',
      level: 1,
      parentId: 'cap-l0-001'
    },
    {
      id: 'cap-l1-011',
      entityType: 'Capability',
      name: 'Matvaneforskning',
      description: 'Forska om matvanor och hälsa',
      level: 1,
      parentId: 'cap-l0-006'
    },
    {
      id: 'cap-l1-012',
      entityType: 'Capability',
      name: 'IT-drift och Support',
      description: 'Driva och supportera IT-system',
      level: 1,
      parentId: 'cap-l0-007'
    },
    {
      id: 'cap-l1-013',
      entityType: 'Capability',
      name: 'Ekonomiadministration',
      description: 'Hantera ekonomi och budget',
      level: 1,
      parentId: 'cap-l0-007'
    },
    {
      id: 'cap-l1-014',
      entityType: 'Capability',
      name: 'HR och Kompetensförsörjning',
      description: 'Rekrytera och utveckla medarbetare',
      level: 1,
      parentId: 'cap-l0-007'
    },

    // LEVEL 2: Specifika förmågor
    {
      id: 'cap-l1-004',
      entityType: 'Capability',
      name: 'Konsumentinformation',
