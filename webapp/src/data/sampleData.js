...
const sampleData = {
  entities: [
    ...
    { id: 'app-001', entityType: 'ApplicationComponent', name: 'eKontroll', description: 'Huvudsystem för livsmedelskontroll', criticality: 'high', lifecycle: 'operational', vendor: 'Verksintern', business_value: 9, technical_health: 4 },
    { id: 'app-002', entityType: 'ApplicationComponent', name: 'Företagsregistret', description: 'Register över livsmedelsföretag', criticality: 'high', lifecycle: 'operational', vendor: 'Verksintern', business_value: 8, technical_health: 5 },
    { id: 'app-003', entityType: 'ApplicationComponent', name: 'Avvikelsehantering', description: 'Hantera kontroll avvikelser', criticality: 'medium', lifecycle: 'operational', vendor: 'Verksintern', business_value: 7, technical_health: 4 },
    { id: 'app-004', entityType: 'ApplicationComponent', name: 'Riskklassificering', description: 'Klassificera företag efter risk', criticality: 'high', lifecycle: 'operational', vendor: 'Verksintern', business_value: 8, technical_health: 3 },
    { id: 'app-005', entityType: 'ApplicationComponent', name: 'Mobil Kontroll-app', description: 'Mobilapp för inspektörer', criticality: 'medium', lifecycle: 'operational', vendor: 'Appva', business_value: 7, technical_health: 5 },
    { id: 'app-006', entityType: 'ApplicationComponent', name: 'Kontrollplan', description: 'Planering av årlig kontroll', criticality: 'medium', lifecycle: 'operational', vendor: 'Verksintern', business_value: 6, technical_health: 4 },
    { id: 'app-007', entityType: 'ApplicationComponent', name: 'Dokumenthantering Kontroll', description: 'Dokumentarkiv för kontroller', criticality: 'medium', lifecycle: 'operational', vendor: 'Microsoft', business_value: 5, technical_health: 7 },
    { id: 'app-008', entityType: 'ApplicationComponent', name: 'Sanktionsregister', description: 'Register över sanktioner', criticality: 'medium', lifecycle: 'operational', vendor: 'Verksintern', business_value: 6, technical_health: 3 },
    { id: 'app-009', entityType: 'ApplicationComponent', name: 'Djurskyddskontroll', description: 'System för djurskyddskontroller', criticality: 'high', lifecycle: 'operational', vendor: 'Verksintern', business_value: 7, technical_health: 4 },
    { id: 'app-010', entityType: 'ApplicationComponent', name: 'GIS Kartverktyg', description: 'Geografisk visualisering', criticality: 'low', lifecycle: 'operational', vendor: 'ESRI', business_value: 4, technical_health: 7 },
    { id: 'app-011', entityType: 'ApplicationComponent', name: 'Mötesbokning Företag', description: 'Företag bokar kontrolltid', criticality: 'low', lifecycle: 'development', vendor: 'Verksintern', business_value: 4, technical_health: 8 },
    { id: 'app-012', entityType: 'ApplicationComponent', name: 'Webbaserad Egenkontroll', description: 'Portal för företag', criticality: 'medium', lifecycle: 'operational', vendor: 'Sunet', business_value: 6, technical_health: 5 },
    { id: 'app-013', entityType: 'ApplicationComponent', name: 'Analysresultat-portal', description: 'Visa analysresultat för företag', criticality: 'low', lifecycle: 'operational', vendor: 'Sunet', business_value: 5, technical_health: 6 },
    { id: 'app-014', entityType: 'ApplicationComponent', name: 'Statistik och Rapportering', description: 'BI-verktyg för kontrolldata', criticality: 'medium', lifecycle: 'operational', vendor: 'Microsoft', business_value: 7, technical_health: 7 },
    { id: 'app-015', entityType: 'ApplicationComponent', name: 'Klagomålshantering', description: 'Hantera klagomål från konsumenter', criticality: 'medium', lifecycle: 'operational', vendor: 'Verksintern', business_value: 6, technical_health: 3 },

    // === KRISBEREDSKAP & UTBROTT (8 appar) ===
    { id: 'app-016', entityType: 'ApplicationComponent', name: 'RASFF Sverige', description: 'EU:s snabbvarslingssystem', criticality: 'critical', lifecycle: 'operational', vendor: 'EU Commission', business_value: 10, technical_health: 8 },
    { id: 'app-017', entityType: 'ApplicationComponent', name: 'Utbrottshantering', description: 'System för utbrottsutredningar', criticality: 'critical', lifecycle: 'operational', vendor: 'Verksintern', business_value: 9, technical_health: 4 },
    { id: 'app-018', entityType: 'ApplicationComponent', name: 'Epidemiologisk Databas', description: 'Spåra smittspridning', criticality: 'high', lifecycle: 'operational', vendor: 'Folkhälsomyndigheten', business_value: 8, technical_health: 6 },
    { id: 'app-019', entityType: 'ApplicationComponent', name: 'Kriskoordination', description: 'Samordna krishantering', criticality: 'critical', lifecycle: 'operational', vendor: 'MSB', business_value: 9, technical_health: 7 },
    { id: 'app-020', entityType: 'ApplicationComponent', name: 'Återkallelsesystem', description: 'Hantera produktåterkallelser', criticality: 'high', lifecycle: 'operational', vendor: 'Verksintern', business_value: 8, technical_health: 4 },
    { id: 'app-021', entityType: 'ApplicationComponent', name: 'Larmcentral', description: 'Ta emot akuta larm', criticality: 'critical', lifecycle: 'operational', vendor: 'Integrationscentrum', business_value: 9, technical_health: 5 },
    { id: 'app-022', entityType: 'ApplicationComponent', name: 'Spårbarhetsdatabas', description: 'Spåra livsmedelsprodukter', criticality: 'high', lifecycle: 'operational', vendor: 'GS1', business_value: 8, technical_health: 7 },
    { id: 'app-023', entityType: 'ApplicationComponent', name: 'Varningspublicering', description: 'Publicera offentliga varningar', criticality: 'high', lifecycle: 'operational', vendor: 'Sunet', business_value: 7, technical_health: 6 },

    // === LABORATORIEVERKSAMHET (10 appar) ===
    { id: 'app-024', entityType: 'ApplicationComponent', name: 'LIMS', description: 'Laboratory Information Management System', criticality: 'high', lifecycle: 'operational', vendor: 'Thermo Fisher', business_value: 9, technical_health: 2 },
    { id: 'app-025', entityType: 'ApplicationComponent', name: 'Provhantering', description: 'Hantera inkommande prover', criticality: 'high', lifecycle: 'operational', vendor: 'Verksintern', business_value: 8, technical_health: 3 },
    { id: 'app-026', entityType: 'ApplicationComponent', name: 'Mikrobiologi-databas', description: 'Mikrobiologiska analysresultat', criticality: 'high', lifecycle: 'operational', vendor: 'Verksintern', business_value: 8, technical_health: 4 },
    { id: 'app-027', entityType: 'ApplicationComponent', name: 'Kemisk Analys', description: 'System för kemiska analyser', criticality: 'high', lifecycle: 'operational', vendor: 'Waters', business_value: 8, technical_health: 6 },
    { id: 'app-028', entityType: 'ApplicationComponent', name: 'DNA-sekvensering', description: 'Genanalys av mikroorganismer', criticality: 'medium', lifecycle: 'operational', vendor: 'Illumina', business_value: 6, technical_health: 8 },
    { id: 'app-029', entityType: 'ApplicationComponent', name: 'Labinstrument Integration', description: 'Integration med  labutrustning', criticality: 'medium', lifecycle: 'operational', vendor: 'Verksintern', business_value: 6, technical_health: 2 },
    { id: 'app-030', entityType: 'ApplicationComponent', name: 'Provspårning', description: 'Spåra prover i labbet', criticality: 'medium', lifecycle: 'operational', vendor: 'Verksintern', business_value: 7, technical_health: 3 },
    { id: 'app-031', entityType: 'ApplicationComponent', name: 'Kvalitetssäkring Lab', description: 'QA/QC-system för labbet', criticality: 'high', lifecycle: 'operational', vendor: 'Verksintern', business_value: 8, technical_health: 4 },
    { id: 'app-032', entityType: 'ApplicationComponent', name: 'Metoddatabas', description: 'Analysmetoder och procedurer', criticality: 'medium', lifecycle: 'operational', vendor: 'Verksintern', business_value: 5, technical_health: 5 },
    { id: 'app-033', entityType: 'ApplicationComponent', name: 'Resultatvalidering', description: 'Validera och godkänna resultat', criticality: 'high', lifecycle: 'operational', vendor: 'Verksintern', business_value: 8, technical_health: 4 },

    // === TILLSTÅND & REGISTRERING (5 appar) ===
    { id: 'app-034', entityType: 'ApplicationComponent', name: 'Tillståndssystemet', description: 'E-tjänst för tillståndsansökningar', criticality: 'high', lifecycle: 'operational', vendor: 'Sunet', business_value: 8, technical_health: 6 },
    { id: 'app-035', entityType: 'ApplicationComponent', name: 'Ärendehantering', description: 'Handlägga tillståndsärenden', criticality: 'high', lifecycle: 'operational', vendor: 'CGI', business_value: 8, technical_health: 5 },
    { id: 'app-036', entityType: 'ApplicationComponent', name: 'Anläggningsregister', description: 'Register över godkända anläggningar', criticality: 'high', lifecycle: 'operational', vendor: 'Verksintern', business_value: 9, technical_health: 3 },
    { id: 'app-037', entityType: 'ApplicationComponent', name: 'Beslutsstöd Tillstånd', description: 'Stöd för tillståndsbeslut', criticality: 'medium', lifecycle: 'development', vendor: 'Verksintern', business_value: 6, technical_health: 8 },
    { id: 'app-038', entityType: 'ApplicationComponent', name: 'Dokumentmall-system', description: 'Mallar för beslut', criticality: 'low', lifecycle: 'operational', vendor: 'Microsoft', business_value: 3, technical_health: 7 },

    // === IMPORT/EXPORT (6 appar) ===
    { id: 'app-039', entityType: 'ApplicationComponent', name: 'TRACES', description: 'EU:s system för import/export', criticality: 'critical', lifecycle: 'operational', vendor: 'EU Commission', business_value: 10, technical_health: 8 },
    { id: 'app-040', entityType: 'ApplicationComponent', name: 'Gränskontroll', description: 'Hantera gränskontroller', criticality: 'high', lifecycle: 'operational', vendor: 'Tullverket', business_value: 8, technical_health: 6 },
    { id: 'app-041', entityType: 'ApplicationComponent', name: 'Exportcertifikat', description: 'Utfärda exportcertifikat', criticality: 'high', lifecycle: 'operational', vendor: 'Verksintern', business_value: 7, technical_health: 4 },
    { id: 'app-042', entityType: 'ApplicationComponent', name: 'Importtillstånd', description: 'Hantera importtillstånd', criticality: 'high', lifecycle: 'operational', vendor: 'Verksintern', business_value: 7, technical_health: 3 },
    { id: 'app-043', entityType: 'ApplicationComponent', name: 'Veterinärcertifikat', description: 'Certifikat för djurprodukter', criticality: 'high', lifecycle: 'operational', vendor: 'Jordbruksverket', business_value: 7, technical_health: 7 },
    { id: 'app-044', entityType: 'ApplicationComponent', name: 'Import/Export-statistik', description: 'Statistik över handel', criticality: 'low', lifecycle: 'operational', vendor: 'SCB', business_value: 4, technical_health: 7 },

    // === DRICKSVATTEN (4 appar) ===
    { id: 'app-045', entityType: 'ApplicationComponent', name: 'Dricksvattendatabas', description: 'Register över vattenverk', criticality: 'high', lifecycle: 'operational', vendor: 'Verksintern', business_value: 8, technical_health: 3 },
    { id: 'app-046', entityType: 'ApplicationComponent', name: 'Vattenprovtagning', description: 'Hantera vattenprovtagning', criticality: 'high', lifecycle: 'operational', vendor: 'Verksintern', business_value: 7, technical_health: 4 },
    { id: 'app-047', entityType: 'ApplicationComponent', name: 'Vattenkvalitetsrapportering', description: 'Rapportera vattenkvalitet', criticality: 'medium', lifecycle: 'operational', vendor: 'Verksintern', business_value: 6, technical_health: 4 },
    { id: 'app-048', entityType: 'ApplicationComponent', name: 'Vattenverk-GIS', description: 'Kartlägg vattenverk', criticality: 'low', lifecycle: 'operational', vendor: 'ESRI', business_value: 4, technical_health: 7 },

    // === KOMMUNIKATION & INFORMATION (7 appar) ===
    { id: 'app-049', entityType: 'ApplicationComponent', name: 'Livsmedelsverket.se', description: 'Huvudwebbplats', criticality: 'high', lifecycle: 'operational', vendor: 'Episerver', business_value: 8, technical_health: 6 },
    { id: 'app-050', entityType: 'ApplicationComponent', name: 'Hitta Rätt App', description: 'Konsumentapp för märkning', criticality: 'medium', lifecycle: 'operational', vendor: 'Verksintern', business_value: 6, technical_health: 4 },
    { id: 'app-051', entityType: 'ApplicationComponent', name: 'Nyhetsbrev-system', description: 'Skicka nyhetsbrev', criticality: 'low', lifecycle: 'operational', vendor: 'MailChimp', business_value: 3, technical_health: 8 },
    { id: 'app-052', entityType: 'ApplicationComponent', name: 'CMS Webbpublicering', description: 'Content Management System', criticality: 'high', lifecycle: 'operational', vendor: 'Episerver', business_value: 7, technical_health: 6 },
    { id: 'app-053', entityType: 'ApplicationComponent', name: 'Pressmeddelanden', description: 'Publicera pressmeddelanden', criticality: 'medium', lifecycle: 'operational', vendor: 'Verksintern', business_value: 5, technical_health: 3 },
    { id: 'app-054', entityType: 'ApplicationComponent', name: 'Sociala Medier-verktyg', description: 'Hantera sociala medier', criticality: 'low', lifecycle: 'operational', vendor: 'Hootsuite', business_value: 3, technical_health: 8 },
    { id: 'app-055', entityType: 'ApplicationComponent', name: 'Kostdatabasen WebAPI', description: 'API för näringsdata', criticality: 'medium', lifecycle: 'operational', vendor: 'Verksintern', business_value: 7, technical_health: 5 },

    // === FORSKNING & VETENSKAP (5 appar) ===
    { id: 'app-056', entityType: 'ApplicationComponent', name: 'Riksmaten', description: 'Nationell kostundersökning', criticality: 'medium', lifecycle: 'operational', vendor: 'Verksintern', business_value: 7, technical_health: 4 },
    { id: 'app-057', entityType: 'ApplicationComponent', name: 'Livsmedelsdata', description: 'Databas över livsmedel', criticality: 'medium', lifecycle: 'operational', vendor: 'Verksintern', business_value: 7, technical_health: 3 },
    { id: 'app-058', entityType: 'ApplicationComponent', name: 'Forskningsdatabas', description: 'Forskningsprojekt och publikationer', criticality: 'low', lifecycle: 'operational', vendor: 'Alfresco', business_value: 4, technical_health: 5 },
    { id: 'app-059', entityType: 'ApplicationComponent', name: 'Biobank-system', description: 'Hantera biologiska prover', criticality: 'medium', lifecycle: 'operational', vendor: 'Verksintern', business_value: 6, technical_health: 4 },
    { id: 'app-060', entityType: 'ApplicationComponent', name: 'Statistikportal', description: 'Publicera statistik', criticality: 'low', lifecycle: 'operational', vendor: 'Tableau', business_value: 5, technical_health: 7 },

    // === ADMINISTRATION & VERKSAMHETSSTÖD (10 appar) ===
    { id: 'app-061', entityType: 'ApplicationComponent', name: 'Agresso Ekonomi', description: 'Ekonomisystem', criticality: 'critical', lifecycle: 'operational', vendor: 'Unit4', business_value: 9, technical_health: 5 },
    { id: 'app-062', entityType: 'ApplicationComponent', name: 'HR-system Primula', description: 'Personal- och lönesystem', criticality: 'critical', lifecycle: 'operational', vendor: 'PIR', business_value: 8, technical_health: 4 },
    { id: 'app-063', entityType: 'ApplicationComponent', name: 'Office 365', description: 'Kontorspaket', criticality: 'high', lifecycle: 'operational', vendor: 'Microsoft', business_value: 7, technical_health: 9 },
    { id: 'app-064', entityType: 'ApplicationComponent', name: 'SharePoint', description: 'Intranät och samarbete', criticality: 'high', lifecycle: 'operational', vendor: 'Microsoft', business_value: 6, technical_health: 8 },
    { id: 'app-065', entityType: 'ApplicationComponent', name: 'Exchange Email', description: 'E-postsystem', criticality: 'critical', lifecycle: 'operational', vendor: 'Microsoft', business_value: 8, technical_health: 9 },
    { id: 'app-066', entityType: 'ApplicationComponent', name: 'Teams', description: 'Samarbetsplattform', criticality: 'high', lifecycle: 'operational', vendor: 'Microsoft', business_value: 7, technical_health: 9 },
    { id: 'app-067', entityType: 'ApplicationComponent', name: 'TimeLog', description: 'Tidsrapportering', criticality: 'medium', lifecycle: 'operational', vendor: 'TimeLog', business_value: 4, technical_health: 6 },
    { id: 'app-068', entityType: 'ApplicationComponent', name: 'Rekryteringssystem', description: 'Hantera rekrytering', criticality: 'medium', lifecycle: 'operational', vendor: 'Visma', business_value: 4, technical_health: 7 },
    { id: 'app-069', entityType: 'ApplicationComponent', name: 'Utbildningsplattform', description: 'Intern utbildning', criticality: 'low', lifecycle: 'operational', vendor: 'Cornerstone', business_value: 3, technical_health: 7 },
    { id: 'app-070', entityType: 'ApplicationComponent', name: 'IT-Servicedesk', description: 'IT-support och incidenthantering', criticality: 'high', lifecycle: 'operational', vendor: 'ServiceNow', business_value: 7, technical_health: 8 },
    
    // === INTEGRATION & INFRASTRUKTUR ===
    { id: 'app-071', entityType: 'ApplicationComponent', name: 'Enterprise Service Bus', description: 'Integrationslager', criticality: 'critical', lifecycle: 'operational', vendor: 'MuleSoft', business_value: 9, technical_health: 3 },
    { id: 'app-072', entityType: 'ApplicationComponent', name: 'API Gateway', description: 'API-hantering', criticality: 'high', lifecycle: 'operational', vendor: 'Azure', business_value: 8, technical_health: 7 },
